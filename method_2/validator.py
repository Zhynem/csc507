...
print(inp_1.to_series())
print(inp_2.to_series())
print(out_f.to_series())
print(inp_1.to_series() + inp_2.to_series() == out_f.to_series())
print((inp_1.to_series() + inp_2.to_series() == out_f.to_series()).all())
